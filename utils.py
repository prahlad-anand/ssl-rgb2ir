...
# Commented out resizes and changed inputs to get_data_loader
...
def get_all_data_loaders(conf):
    ...
    if 'data_root' in conf:
        train_loader_a = get_data_loader_folder(os.path.join(conf['data_root'], 'train_A'), batch_size, True,
                                              new_size_a, new_size_b, new_size_a, num_workers, True)
        ...
        train_loader_b = get_data_loader_folder(os.path.join(conf['data_root'], 'train_B'), batch_size, True,
                                              new_size_b, new_size_b, new_size_a, num_workers, True)
...
def load_vgg16(model_dir):
    ...
    if not os.path.exists(os.path.join(model_dir, 'vgg16.weight')):
        ...
        vgglua = torchfile.load('/home/hri/PycharmProjects/Thermal_optical_flow/MUNIT/models/vgg16.t7')
